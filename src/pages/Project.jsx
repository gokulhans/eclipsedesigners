...
function Project({ link, title }) {
    ...
    return (
        <>
            <h2 class="mb-8 text-3xl md:text-4xl font-bold leading-none text-center text-green-600 nodark:text-green-400">{title}</h2>

            <h2 class="my-8 mt-12 ml-5 text-2xl md:text-3xl font-bold leading-none md:ml-16 nodark:text-white">Demo Video</h2>
            ...
            <div class="px-4 pb-24 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-10 text-gray-800">
                ...
                <h2 class="py-6 pt-8 text-2xl md:text-3xl font-bold leading-none nodark:text-white">Technologies Used</h2>

                <ul class="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
                    <li class="flex items-center space-x-2 nodark:text-white">
                        <span>React JS</span>
                    </li>
                    <li class="flex items-center space-x-2 nodark:text-white">
                        <span>Firebase</span>
                ...
                <h2 class="py-8 text-2xl md:text-3xl font-bold leading-none nodark:text-white">Bundle Contain</h2>
            ...
            <div className="text-xl fixed bottom-5 right-5 left-5 bg-green-600 text-white rounded-md z-20">
                <a href='https://wa.me/message/5XWWJKY6UH5EG1' class="flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md bg-green-600 text-gray-50 nodark:text-black nodark:bg-green-500">Book This Project Now</a>
            </div>
        </>
    )
}
