    ...
    return (
        <section className=" text-gray-800 dark:bg-gray-800 dark:text-gray-100">
            ...
            <h1 className="text-gray-700 dark:text-white leading-tight md:text-7xl text-4xl sm:text-5xl font-extrabold">Ready Made
                ...
                <h1 className="text-gray-700 dark:text-white leading-tight md:text-7xl text-4xl sm:text-5xl font-extrabold">Final Year Projects
                    <span className="text-green-600 dark:text-green-400"> BCA & CS</span>
                </h1>
