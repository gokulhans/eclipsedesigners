...
function Navbar() {
    return (
        <nav class="bg-white px-2 sm:px-4 py-2 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 shadow dark:border-gray-600">
